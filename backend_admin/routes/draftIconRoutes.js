...
const { saveDraftIcons, getParticularPackIconItem, saveActiveIcons, getAllActiveIconItem } = require("../controller/adminControllers/Icons/iconItemController");
...
router.get("/getActiveIcons",getAllActiveIconItem);
